  ...
  try {
    ...
    if (res.produto === null) {
      return res.status(404).json({
        message: "Nao foi possivel encontrar um produto com o id informado",
      });
    }
  } catch (err) {
...
router.get("/popula", async (req, res) => {
  await new Produto({
    ...
    tipo: "Bebida",
    foto:
      "https://d3efjz1jvymzgz.cloudfront.net/Custom/Content/Products/10/11/1011792_refrigerante-coca-cola-lata-350ml-fardo-c-12-unidades_m1_637051111791632885.png",
  }).save();
  await new Produto({
    nome: "Suco de Laranja - Jarra",
    valor: 8.0,
    tipo: "Bebida",
    foto:
      "https://image.freepik.com/fotos-gratis/jarra-de-suco-de-laranja-e-frutas-laranja-isoladas_80510-975.jpg",
  }).save();
  await new Produto({
    nome: "Batata Frita",
    valor: 11.0,
  ...
  await new Produto({
    ...
    tipo: "Petisco",
    foto:
      "https://teretetenacozinha.com.br/wp-content/uploads/2019/02/P%C3%A3o-de-Alho-com-r.save()equeij%C3%A3o.png",
  }).save();
  await new Produto({
    nome: "Filé a Parmegiana",
    valor: 18.0,
    tipo: "Refeição",
    foto: "https://leianoticias.com.br/wp-content/uploads/Fil%C3%A9-capa.jpg",
  }).save();
  await new Produto({
    nome: "Feijoada",
    valor: 35.0,
    tipo: "Refeição",
    foto: "https://img.cybercook.com.br/receitas/776/feijoada-623x350.jpeg",
  }).save();
